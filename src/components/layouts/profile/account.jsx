...
function Account() {
    return (
        <div >
            <div className="w-[1000px] rounded-[12px] p-[24px] gap-[24px] bg-[#FFFFFF] flex flex-col gap-5">
                <div className="w-full flex flex-col gap-5 opacity-[1px] ">
                    {/* firstname */}
                    <div className="w-full h-[76px] gap-[16px] opacity-[1px] flex">
                        <div className="w-[50%] h-[76px] gap-[8px] flex flex-col">
                    ...
                    {/* email */}
                    <div className="w-full h-[76px] gap-2 opacity-[1px] flex flex-col">
                    ...
                    {/* password */}
                    <div className="w-full h-[78px] gap-[16px] opacity-[1px] flex ">
                        <div className="w-[50%] h-[76px] opacity-[1px] gap-[8px] flex flex-col">
                        ...
                        {/* whatsapp number */}
                        <div className="w-[50%] h-[78px] opacity-[1px] gap-[8px]">
                    ...
                    <div className="w-full h-[76px] gap-[8px] opacity-[1px] flex flex-col">
                ...
                {/* Upload Box */}
                <div className="w-full h-[170px] gap-[8px] opacity-[1px] flex justify-between">
                    ...
                    <label className="w-[70%] h-[170px]  gap-[10px] border-2 border-dashed rounded-[40px] p-6 text-center cursor-pointer hover:border-blue-400 transition mr-[60px]">
