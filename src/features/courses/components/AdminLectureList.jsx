            ...
            <div className="p-6">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                    ...
                    <div className="flex items-center gap-2 w-full sm:w-auto">
                        ...
                        <button className="bg-[#6366F1] hover:bg-[#4f46e5] text-white px-3 sm:px-5 py-2 rounded-lg text-sm font-bold flex items-center gap-2 whitespace-nowrap transition-colors">
                            <Search size={16} /> <span className="hidden sm:inline">Search</span>
                        </button>
                    </div>
                </div>

                <div className="overflow-x-auto min-w-[900px] lg:min-w-0">
