...
const AdminCalendar = () => {
    ...
    const getEventIcon = (event) => {
        ...
        if (type.includes('lecture') || title.includes('lecture')) {
            return (
                <svg className="w-[11px] h-[11px] mr-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.2">
        ...
        if (type.includes('community') || title.includes('community')) {
            return (
                <svg className="w-[11px] h-[11px] mr-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.2">
        ...
        return (
            <svg className="w-[11px] h-[11px] mr-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.2">
                <path strokeLinecap="round" strokeLinejoin="round" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 0 1 0 2.828l-7 7a2 2 0 0 1-2.828 0l-7-7A1.994 1.994 0 0 1 3 12V7a4 4 0 0 1 4-4z" />
            </svg>
        );
    };
