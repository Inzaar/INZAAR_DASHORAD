...
import AssignManagementAccessModal from "../components/student/AssignManagementAccessModal";
...
const ManagementDetails = () => {
  ...
  const handleAssignModalSave = async (data) => {
    try {
      ...
      toast.success("Management access updated successfully!");
  ...
  const handleDeactivate = async () => {
    try {
      ...
      toast.success("Management deactivated successfully!");
      navigate('/admin-management');
    } catch (err) {
      toast.error("Failed to deactivate management");
      console.error(err);
    }
  };
  ...
  const handleRestore = async () => {
    try {
      ...
      toast.success("Management restored successfully!");
      fetchProfileData();
    } catch (err) {
      toast.error("Failed to restore management");
      console.error(err);
    }
  };
