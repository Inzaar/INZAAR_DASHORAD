...
const CreateQuiz = ({ onBackToSelection, onComplete, courseId }) => {
    ...
    return (
        <div className="flex-1 flex flex-col w-full min-h-0 overflow-hidden font-sans bg-[#f8fafc] relative">
            ...
            <div className="mb-6 md:mb-8 px-4 md:px-0">
                ...
                <h1 className="text-[22px] md:text-[28px] font-bold text-[#0f172a] mb-1 md:mb-2 tracking-tight">Create New Quiz</h1>
            ...
            {/* Stepper */}
            <div className="flex items-center justify-center gap-2 sm:gap-4 md:gap-6 mb-8 md:mb-12 w-full px-2 sm:px-4 md:px-0">
                {steps.map((s, idx) => (
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar px-4 sm:px-6 mb-4">
                ...
                {currentStep === 2 && (
                    <div className="flex-1 w-full px-4 md:px-0 bg-white rounded-[20px] md:rounded-[32px] p-6 md:p-12 border border-gray-50 shadow-[0_20px_50px_rgba(0,0,0,0.03)] mb-8 md:mb-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-8 md:px-8 lg:px-12">
                            {[
                                ...
                                >
                                    ...
                                    ${method === opt.id
                                            ? 'bg-gradient-to-br from-[#B666E7] to-[#3758EE] text-white shadow-purple-500/40 scale-110'
                                ...
                                `}>
                                    ...
                                    <h4 className={`text-[16px] md:text-[20px] font-bold mb-2 md:mb-3 transition-colors ${method === opt.id ? 'text-[#0f172a]' : 'text-[#64748b]'}`}>
                                        {opt.title}
                                    </h4>
                                    <div className="space-y-1">
                                        <p className={`text-[12px] md:text-[14px] font-medium transition-colors ${method === opt.id ? 'text-[#0f172a]' : 'text-gray-400'}`}>
                                            {opt.line1}
                                        </p>
                                        <p className={`text-[10px] md:text-[12px] font-medium transition-colors ${method === opt.id ? 'text-[#64748b]' : 'text-gray-300'}`}>
                                            {opt.line2}
                                        </p>
                                    </div>
                                </div>
                ...
                {/* Form Content - Step 3: CSV Upload */}
                {currentStep === 3 && method !== 'manual' && (
                    <div className="flex-1 w-full px-4 sm:px-6 md:px-0 space-y-5 md:space-y-6 pb-10 font-sans">
                        {/* Card 1: Download CSV Template */}
                        <div className="bg-white rounded-[12px] md:rounded-[16px] p-5 sm:p-6 md:p-8 border border-gray-200 shadow-sm">
                            <h3 className="text-[16px] md:text-[17px] font-bold text-[#0f172a] mb-1.5 leading-tight">Download CSV Template</h3>
                            <p className="text-[12px] md:text-[14px] text-[#64748b] font-medium mb-5 md:mb-6 leading-relaxed">Use the provided format to ensure successful question import.</p>

                            <div className="bg-[#f8fafc] rounded-[10px] p-4 sm:p-5 mb-5 md:mb-8 border border-[#f1f5f9]">
                                <p className="text-[11px] md:text-[12px] text-[#64748b] font-semibold mb-3">Required Columns:</p>
                                <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-3">
                                    {['question_text', 'option_1', 'option_2', 'option_3', 'option_4', 'correct_answer', 'explanation', 'points', 'difficulty'].map((col) => (
                                        <div key={col} className="bg-white border border-gray-200 rounded-[6px] px-2 md:px-3 py-2 md:py-2.5 text-[10px] md:text-[12px] text-[#0f172a] font-medium truncate shadow-sm flex items-center justify-center sm:justify-start">
                                            {col}
                                        </div>
                                    ))}
                                </div>
                            ...
                            <button className="bg-[#8b5cf6] hover:bg-[#7c3aed] text-white px-5 py-2.5 md:py-3 rounded-[8px] text-[13px] md:text-[14px] font-medium flex items-center justify-center gap-2.5 transition-all w-full sm:w-auto shadow-sm mx-auto sm:mx-0">
                        ...
                        <div className="bg-white rounded-[12px] md:rounded-[16px] p-5 sm:p-6 md:p-8 border border-gray-200 shadow-sm">
                            ...
                            >
                                ...
                                <p className="text-[11px] md:text-[12px] text-[#94a3b8] font-medium mt-6 md:mt-8 text-center">Supported format: .csv (Max 5MB)</p>
                            </div>
                        </div>
                    </div>
                )}

                {/* Form Content - Step 4: Settings */}
                {currentStep === 4 && (
                    <div className="flex-1 w-full space-y-6 sm:space-y-8 px-4 md:px-0 pb-10">
                        {/* Quiz Behavior Card */}
            ...
            {/* Footer Buttons */}
            <div className="flex-shrink-0 flex flex-col sm:flex-row items-center justify-between w-full gap-4 px-4 md:px-6 py-5 border-t border-gray-100 bg-[#f8fafc] z-20">
                <button
                    onClick={handleBack}
